  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-xlg-12 col-md-12">
      <div class="ribbon-wrapper card">
        <div class="ribbon ribbon-bookmark ribbon-danger">Guest Customer Orders</div>
        <div class="card-body">
           <!-- Create modal -->
          <div class="align-self-center">
            <table class="table table-responsive" id="guestOrderTable">
              <thead>
                <tr>
                  <th>Index</th>
                  <th>Date</th>
              ...
              <tbody>
                @foreach($allGuestOrders as $key=>$order)
                <tr>
                  <td>{{$key+1}}</td>
...
<div id="deletemodaluser{{$order->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <form action="{{route('guest.orderDelete',[$order->id])}}" method="post">@csrf
      {{method_field('POST')}}
